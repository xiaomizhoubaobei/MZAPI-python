...
class Novel_8K:
    ...
    def get_response(
        ...
        """
        return self.M.get_response(data, temperature, top_p, penalty_score, enable_system_memory, disable_search, enable_citation, stream, system, stop, enable_trace, max_output_tokens)