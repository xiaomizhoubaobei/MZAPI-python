...
class Qianfan_Chinese:
    """
    Qianfan_Chinese类用于与百度Qianfan-Chines-Llama-2-70B模型进行交互。
    ...
    主要方法:
    - get_response: 发送请求到Qianfan-Chinese-Llama-2-70B模型并获取响应
    """

    def __init__(self, client_name, ak, sk,token=None):
            host_name="Qianfan-Chinese-Llama-2-70B"
            http_host="https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/qianfan_chinese_llama_2_70b"
