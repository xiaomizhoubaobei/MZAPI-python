...
class FictionalEightK:
    ...
    def __init__(self, client_name, ak, sk, token=None):
            host_name="ERNIE-Character-Fictional-8K"
            http_host="https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/ernie-char-fiction-8k"
