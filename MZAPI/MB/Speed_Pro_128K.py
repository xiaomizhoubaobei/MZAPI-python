...
class Speed_Pro_128K:
    ...
    def __init__(self, client_name, ak, sk):
        ...
        self.apm_client = APMClient(
            ...
            peer_service="ERNIE-Speed-Pro-128K",
            peer_instance=" 180.97.107.95:443",
            peer_address=" 180.97.107.95",
            peer_ipv6="240e:ff:e020:934:0:ff:b0dc:3636",
            http_host="https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/ernie-speed-pro-128k",
            server_name="MZAPI",
        )
    ...
    def get_response(
        ...
        """
        with self.tracer.start_as_current_span("ERNIE-Speed-Pro-128K") as span:
            url = (
                "https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/ernie-speed-pro-128k?access_token="
                + self.access_token
            )
            payload = json.dumps(
                {
            ...
            self.log.start_process_log(response.json(), "ERNIE-Speed-Pro-128K", W)
            M = response.json()
            uuid1 = Request_id
            question = data
            answer = M.get("result")
            ...
            self.sql.get_response(uuid1, question, answer, W, self.ip, "ERNIE-Speed-Pro-128K")
            return X
