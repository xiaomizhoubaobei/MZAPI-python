...
class Chat_4bit:
    """
    Chat_4bit 类用于与百度XuanYuan-70B-Chat-4bit模型进行交互。
    ...
    主要方法:
    - get_response: 发送请求到XuanYuan-70B-Chat-4bit模型并获取响应
    """

    def __init__(self, client_name, ak, sk, token=None):
            host_name="XuanYuan-70B-Chat-4bit"
            http_host="https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/xuanyuan_70b_chat"
